            ...
            <form action="<?php echo site_url(); ?>/_includes/process-edit-recipes.php" method="POST">
              <div class="block">
                ...
                <input class="border-black border-2" type="text" name="first_name"
                  value="<?php echo $recipe['first_name']?>">
              </div>

              <div class="block">
                <label for="">Last Name</label>
                <input class="border-black border-2" type="text" name="last_name"
                  value="<?php echo $recipe['last_name']?>">
              </div>
              <div class=" block">
                <label for="">Email</label>
                <input class="border-black border-2" type="email" name="email" value="<?php echo $recipe['email']?>">
              </div>
              <div class=" block">
                <label for="">Phone Number</label>
                <input class="border-black border-2" type="text" name="phone" value="<?php echo $recipe['phone']?>">
              </div>
